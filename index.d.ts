...
export default class ReactSelectClass<TValue = OptionValues> extends React.Component<ReactSelectProps<TValue>, any> {
    focus(): void;
}
// Other components
export class Creatable<TValue = OptionValues> extends React.Component<ReactCreatableSelectProps<TValue>, any> { }
export class Async<TValue = OptionValues> extends React.Component<ReactAsyncSelectProps<TValue>, any> { }
export class AsyncCreatable<TValue = OptionValues> extends React.Component<ReactAsyncSelectProps<TValue> & ReactCreatableSelectProps<TValue>, any> { }
